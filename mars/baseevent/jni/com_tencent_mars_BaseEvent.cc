...
JNIEXPORT void JNICALL Java_com_protruly_im_core_longlink_BaseEvent_onForeground (JNIEnv *, jclass, jboolean _isforeground)
{
    mars::baseevent::OnForeground(_isforeground);
}

JNIEXPORT void JNICALL Java_com_protruly_im_core_longlink_BaseEvent_onNetworkChange (JNIEnv *, jclass)
{
	mars::baseevent::OnNetworkChange();
}

JNIEXPORT void JNICALL Java_com_protruly_im_core_longlink_BaseEvent_onSingalCrash(JNIEnv *, jclass, jint _sig){
    mars::baseevent::OnSingalCrash((int)_sig);
}

JNIEXPORT void JNICALL Java_com_protruly_im_core_longlink_BaseEvent_onExceptionCrash(JNIEnv*, jclass){
